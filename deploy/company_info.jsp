...
.pg .breather__cue{
  position:relative; width:2px; height:46px; margin:26px auto 0;
  background:rgba(25,25,25,.16); overflow:hidden;
}
.pg .breather__cue::after{
  content:""; position:absolute; left:0; top:0; width:100%; height:42%;
  background:var(--ink); border-radius:2px;
  animation:cue-drop 2.3s cubic-bezier(.5,0,.5,1) infinite;
}
@keyframes cue-drop{
...
@media (prefers-reduced-motion:reduce){
  ...
  .pg .breather__cue::after{ animation:none; height:100%; opacity:.4; }
...
<div class="pg">
  ...
  <section class="breather">
    ...
    <div class="breather__cue" aria-hidden="true"></div>
  </section>
