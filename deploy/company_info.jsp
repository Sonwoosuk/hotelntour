...
.pg .diff__places--type{ margin-top:8px; gap:8px; }
.pg .diff__places--type li{ background:var(--orange); color:var(--white); padding:7px 13px !important; font-size:11.5px; }
.pg .diff__places--gap-lg{ margin-top:16px; }
  ...
  <section class="sec">
    <div class="wrap">
      <div class="diff__panel">
        ...
        <ul class="diff__places"><li>하와이</li><li>몰디브</li><li>발리</li><li>푸켓</li><li>코사무이</li><li>유럽</li></ul>
        <ul class="diff__places diff__places--type diff__places--gap-lg"><li>가족여행</li><li>신혼여행</li><li>우정여행</li></ul>
        <ul class="diff__places diff__places--type"><li>리마인드허니문</li><li>효도여행</li></ul>
      </div>
    </div>
  </section>
